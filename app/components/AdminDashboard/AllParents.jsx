                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex justify-between py-2 border-b">
                                    ...
                                    <span className="capitalize">{selectedParent.subscription}</span>
                                </div>
                                <div className="flex justify-between py-2 border-b">
                                    <span className="font-medium text-gray-600">Total Deals:</span>
                        ...
                        <div className="mt-6 space-y-3">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="flex justify-between py-2 border-b">
                                    ...
                                    <span>{new Date(selectedParent.createdAt).toLocaleDateString()}</span>
                                </div>
                                <div className="flex justify-between py-2 border-b">
                                    <span className="font-medium text-gray-600">Last Updated:</span>
                                    <span>{new Date(selectedParent.updatedAt).toLocaleDateString()}</span>
                                </div>
                            </div>
                        </div>
